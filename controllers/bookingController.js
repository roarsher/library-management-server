...
// //     (sum, a) =>
// //       sum + a.priceAtBooking * a.quantity,
// //     0
// //   );
...
// //     // Store coupon information if your
// //     // SeatBooking schema supports these fields.
// //     couponCode: coupon
// //       ? coupon.code
// //       : undefined,
...
// //     // IMPORTANT:
// //     // Respect add-on quantities when recalculating.
// //     const addOnsTotal =
...
//   if (!student) {
//     return res.status(404).json({
//       message: 'Student profile not found — complete your profile first',
//     });
//   }
...
//     // Booking must remain pending until
//     // an admin approves it after payment verification.
//     status: 'pending_approval',
...
//   // Booking can only be approved when at least one
//   // payment linked to this booking has been verified.
//   //
//   // This replaces the old admission-verification gate.
